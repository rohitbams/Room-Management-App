...
public class BookingDTO {
   ...
   /*  public BookingDTO(Long id, String eventName, Long roomId, String roomName, Date startTime, 
                     int duration, Long organiserId, String organiserName, 
                     List<AttendeeDTO> attendees, int currentAttendees, int maxCapacity) {
        this.id = id;
